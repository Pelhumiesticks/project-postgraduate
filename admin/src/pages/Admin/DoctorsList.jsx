...
const DoctorsList = () => {
  ...
  return (
    <div className='m-5 max-h-[90vh] overflow-y-scroll'>
      <h1 className='text-lg font-medium text-gray-600'>All Caregivers</h1>
      <div className='w-full flex flex-wrap gap-4 pt-5 gap-y-6'>
        {doctors.map((doc, index) => (
          <div className='border border-indigo-300 rounded-xl max-w-56 overflow-hidden cursor-pointer group' key={index}>
            <img className='bg-indigo-100 group-hover:bg-primary transition-all duration-500' src={doc.image} alt="" />
            <div className='p-4'>
