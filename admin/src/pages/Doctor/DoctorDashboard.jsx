...
const DoctorDashboard = () => {
  ...
  const {dashData, dToken, setDashData, getDashData,markAppointment, cancelAppointment } = useContext(DoctorContext)
...

          {
            dashData.latestAppointment.map((item, index)=>(
              <div className='flex items-center px-6 py-3 hover:bg-gray-100' key={index}>
                ...
                <img onClxick={()=>markAppointment(item._id)} className='w-10 cursor-pointer' src={assets.tick_icon} alt="" />
                </div>
